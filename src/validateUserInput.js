...
export { sanitizeInput, validateEmail, validatePassword };function validateUsername(username) {
...
export { validateUserCredentials };function validateUserInput(username, password) {
    const usernameRegex = /^[a-zA-Z0-9_]{3,20}$/;
    const passwordRegex = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&]{8,}$/;
